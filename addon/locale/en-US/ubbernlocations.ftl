itemmenu-submenu =
    .label = Swisscovery UB Bern Location Lookup
...
picker-footer-existing-all = Tagged (all):
picker-footer-existing-single = Tagged:
picker-footer-existing-partial = Tagged (some):
